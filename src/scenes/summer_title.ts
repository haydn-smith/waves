...
export class SummerTitle extends Phaser.Scene {
  ...
  constructor() {
    super(Scene.SummerTitle);
  }

  create() {
    logEvent('Creating "Summer Title" scene.');
    ...
    sequence(this)
      .of([
        ...
        wait(500),
        runCallback(() => this.typewriter2.typewrite(`[sprite:${Sprite.SummerIcon}] Summer`)),
        ...
        wait(1000),
        runCallback(() => this.scene.start(Scene.SummerJetty)),
      ])
      .start()
      .destroyWhenComplete();
  }
